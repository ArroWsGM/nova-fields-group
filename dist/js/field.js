...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('detail-nova-fields-group', __webpack_require__(3));
    Vue.component('form-nova-fields-group', __webpack_require__(6));
});
...
var render = function() {
  ...
  return _vm.field.fields.length > 0
    ? _c(
        "div",
        _vm._l(_vm.field.fields, function(childField, index) {
          return _c(_vm.resolveComponentName(childField), {
            key: index,
            tag: "component",
            class: {
              "remove-bottom-border": index === _vm.field.fields.length - 1
            },
            attrs: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.fields.forEach(function (field) {
            field.panel = _this.field.panel;
        });
    },
    mounted: function mounted() {
        var wrapper = this.$parent.$el;
    ...
    methods: {
        setChildrenValue: function setChildrenValue(index, event) {
